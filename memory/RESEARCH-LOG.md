...
- Equity: $100,697.74
- Cash: $41,487.81
- Buying power: $142,185.55
- Daytrade count: 0

### Market Context
- S&P 500 futures: +0.10% at 6,657.50
- VIX: n/a (data unavailable pre-market)
- Sector momentum: Technology leading
- Today's catalysts: No major earnings pre-open identified
- Deployed: 58.8% (below 75-85% target — need 1-2 more positions next week)

### Existing Positions
- AMD $335.95 (+6.7% from entry) — trailing stop $307.34
- NVDA $207.87 (-0.1%) — trailing stop $193.26
- PLTR $137.90 (-3.0%) — trailing stop $129.47; manual cut at $132.34 (-7%)

### Trade Ideas
- No new trades: weekly limit 3/3 exhausted (all placed 2026-04-28)
- Watchlist for next week: look for 1-2 new positions to bring deployment to 75-80%

### Risk Factors
- PLTR at -3.0%; one more leg down hits manual cut at -7%
- Deployment below target — underperforms in strong up-tape

### Decision
HOLD — weekly trade cap reached. All stops in place. Monitor PLTR closely.

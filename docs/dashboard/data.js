// ============ DATA — origin/main, latest log 2026-09-21 ============
...
{d:"2026-09-18",n:103,v:103282.35,cash:20.1,dp:-0.34,note:""},
{d:"2026-09-21",n:105,v:102959.64,cash:20.1,dp:-0.31,note:""}
];
...
{w:"09/18", bot:-0.62, spx:-0.38, spxc:-0.38, est:0}
];

const BOOK = [ // Sep 21 EOD
{s:"XLB", q:412, in:51.07, pl:-560.45, plp:-2.66, stop:48.78, protection:"fixed", w:19.9},
{s:"XLE", q:311, in:63.92, pl:-454.61, plp:-2.29, stop:58.275, protection:"trailing", w:18.9},
{s:"XLK", q:112, in:187.85, pl:784.00, plp:3.73, stop:175.581, protection:"trailing", w:21.2},
{s:"XLP", q:250, in:83.76, pl:-460.00, plp:-2.20, stop:79.91, protection:"fixed", w:19.9}
];
...
const RULES = [{"ok": "?", "c": "warn", "t": "Logged protection", "v": "2 trailing / 2 fixed; broker status unverified"}, {"ok": "?", "c": "warn", "t": "Historical rule compliance", "v": "not independently verified"}, {"ok": "✓", "c": "up", "t": "Logged deployment", "v": "79.8% as of 2026-09-21"}];
...
// Commentary as of 2026-09-17; not a live safety certification.
const INSIGHTS = [
